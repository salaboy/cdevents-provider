...
import (
	...
	"github.com/salaboy/cdevents-provider/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("cdevents-provider"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-cdevents-provider",
